...
public class SuggestionsDialog extends DialogBox implements ChangeHandler {
	...
	public SuggestionsDialog(BubbleView bubble) {
		...
		setAutoHideEnabled(true); // should be automatically hidden when the
			...
			builder.sendRequest(null, new RequestCallback() {
				...
				public void onResponseReceived(Request request,
					...
					if (200 == response.getStatusCode()) {
						...
						JSONArray a = value.isObject().get("synonyms")
								.isArray();
						...
						list_box.addChangeHandler(SuggestionsDialog.this); // now
																			// make
																			// it
																			// clickable
