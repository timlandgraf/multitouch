...
public class Line extends VectorObject implements Strokeable, Animatable {
	...
	public void setX1(int x1) {
		SVGBase.setX(getElement(), x1, isAttached());
	}
	...
	public void setY1(int y1) {
		SVGBase.setY(getElement(), y1, isAttached());
	}
	 ...
	 */
	public int getX2() {
		return SVGBase.getLineX2(getElement());
	}
	...
	public void setX2(int x2) {
		SVGBase.setLineX2(getElement(), x2);
	}
	 ...
	 */
	public int getY2() {
		return SVGBase.getLineY2(getElement());
	}
	...
	public void setY2(int y2) {
		SVGBase.setLineY2(getElement(), y2);
	}
