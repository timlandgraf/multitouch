...
public abstract class VectorObject extends Widget implements HasClickHandlers,
	...
	public VectorObject() {
		setElement(SVGBase.createElement(getType()));
	}

	protected abstract Class<? extends VectorObject> getType();

	public int getRotation() {
		return SVGBase.getRotation(getElement());
	}

	public void setRotation(int degree) {
		SVGBase.setRotation(getElement(), degree, isAttached());
	}
	...
	public void setStyleName(String style) {
		SVGBase.setStyleName(getElement(), style);
	}
	...
	protected void onAttach() {
		super.onAttach();
		SVGBase.onAttach(getElement(), isAttached());
	}
